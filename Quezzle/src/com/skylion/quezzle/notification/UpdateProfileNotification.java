 ...
 */
public class UpdateProfileNotification {
    public static final String ACTION = "com.skylion.quezzle.notification.UpdateProfileNotification.UPDATE_PROFILE";

    private  static final String RESULT_DATA = "com.skylion.quezzle.notification.UpdateProfileNotification.RESULT";
    private  static final String ERROR_MESSAGE_DATA = "com.skylion.quezzle.notification.UpdateProfileNotification.ERROR_MESSAGE";
