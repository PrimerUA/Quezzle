...
/**
 * Created with IntelliJ IDEA. User: Kvest Date: 23.03.14 Time: 11:01 To change
...
public class ChatListAdapter extends CursorAdapter {
	public static final String[] PROJECTION = new String[] { ChatPlaceTable._ID, ChatPlaceTable.NAME_COLUMN,
			ChatPlaceTable.DESCRIPTION_COLUMN, ChatPlaceTable.OBJECT_ID_COLUMN, ChatPlaceTable.CHAT_TYPE_COLUMN };
	...
	public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
		...
		holder.type = (ImageView) view.findViewById(R.id.chat_type);
		view.setTag(holder);
